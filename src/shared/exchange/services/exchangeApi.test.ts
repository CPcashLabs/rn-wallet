...
describe("exchangeApi", () => {
      ...
      options: [
        {
          ...
          sendCoinSymbol: "",
          sendChainName: "BTT",
          sendChainFullName: "BitTorrent Chain",
          sendChainLogo: "btt.png",
          sendChainColor: "#10d8ff",
          paymentNetworkName: "BitTorrent Chain",
          paymentNetworkLogo: "coin.png",
          paymentNetworkColor: "#10d8ff",
  ...
  it("prefers the asset origin network for wrapped same-chain options", async () => {
    mockGetCoinList.mockResolvedValue([
      {
        code: "USDT_t",
        symbol: "USDT",
        ...
        logo: "usdt-tron.png",
        chainName: "BTT_TEST",
        chainFullName: "BitTorrent Test Network",
        chainLogo: "btt-test.png",
        chainColor: "#10d8ff",
        contract: "0xusdt-tron",
        price: 1,
        precision: 6,
      },
      {
    ...
    mockRequestCoinAllowList.mockResolvedValue([
      {
        chain_name: "BTT_TEST",
        chain_full_name: "BitTorrent Test Network",
        chain_logo: "btt-test.png",
        chain_color: "#10d8ff",
        chain_address_format_regex: ["^0x"],
        coins: [
          {
            chain_name: "BTT_TEST",
            coin_code: "USDT_t",
            coin_full_name: "USDT Tron",
            coin_logo: "usdt-tron.png",
            coin_symbol: "USDT",
            is_send_allowed: true,
            is_recv_allowed: true,
          },
          {
            chain_name: "BTT_TEST",
            coin_code: "USDT_b",
            coin_full_name: "USDT Binance",
            coin_logo: "usdt-bsc.png",
            coin_symbol: "USDT",
            is_send_allowed: true,
            is_recv_allowed: true,
          },
      ...
      options: [
        {
          ...
          sendChainLogo: "btt-test.png",
          sendChainColor: "#10d8ff",
          paymentNetworkName: "Tron",
          paymentNetworkLogo: "usdt-tron.png",
          paymentNetworkColor: "#EB0029",
          recvCoinCode: "",
          recvCoinSymbol: "",
          feeAmount: 0,
          recvEstimateAmount: 0,
          sendMinAmount: 0,
          sendCoinContract: "0xusdt-tron",
        },
        {
          sellerId: "",
          sendCoinCode: "USDT_b",
          ...
          sendChainLogo: "btt-test.png",
          sendChainColor: "#10d8ff",
          paymentNetworkName: "Binance",
          paymentNetworkLogo: "usdt-bsc.png",
          paymentNetworkColor: "#F3BA2F",
          recvCoinCode: "",
          recvCoinSymbol: "",
          feeAmount: 0,
          recvEstimateAmount: 0,
          sendMinAmount: 0,
          sendCoinContract: "0xusdt-bsc",
        },
      ],
    })
  })
    ...
    await expect(
      ...
      options: [
        ...
        },
        {
          ...
          sendChainName: "BTT",
          sendChainFullName: "BTT",
          sendChainLogo: "",
          sendChainColor: "",
          paymentNetworkName: "BTT",
          paymentNetworkLogo: "",
          paymentNetworkColor: "",
