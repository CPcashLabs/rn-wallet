...
import { createNativeOrder } from "@/features/receive/services/receiveApi"
...
export function BuyCryptoScreen({ navigation }: Props) {
    ...
    <HomeScaffold canGoBack onBack={navigation.goBack} title={t("receive.buy.title")} scroll={false}>
      <View style={styles.content}>
        ...
        <Pressable
          ...
          style={[styles.button, { backgroundColor: theme.colors.primary, opacity: submitting || !amount || !address ? 0.6 : 1 }]}
        >
